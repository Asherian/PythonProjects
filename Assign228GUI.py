...
class ParentWindow(Frame):
    def __init__ (self,master):
        ...
        self.btnCheck = Button(self.master, text="Check for files", width=12, height=2,command=self.Move)
        self.btnCheck.grid(row=2, column=0, padx=(30,0), pady=(20,0))

        self.btnMove = Button(self.master, text="Move files", width=12, height=2,command=self.Check)
        self.btnCheck.grid(row=2, column=1, padx=(30,0), pady=(20,0))
    ...
    def Move(self,browSource, browDestination):
        for i in varFolder:
            shutil.move(varFolder+i,varDestFold)
